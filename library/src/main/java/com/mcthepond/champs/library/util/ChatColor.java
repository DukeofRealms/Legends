 ...
 * Credit goes to Bukkit ( @ http://bukkit.org ) for creating this class. NOT MY WORK.
 */
public enum ChatColor {
     ...
     * @return Associative {@link com.mcthepond.champs.library.util.ChatColor} with the given code, or null if it doesn't exist
     */
