...
public class CommandHandler {
    ...
    public static CommandResult exec(CommandSender sender, String commandName, String[] arg) {
        if (arg.length == 0) {
            sender.sendMessage(ChatColor.RED + "Not enough arguments! /champs help");
        }
